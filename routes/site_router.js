...
var install = require('../scripts/install_chaincode.js')
var instantiate = require('../scripts/instantiate_chaincode.js')
...
router.route('/invoke').get(function(req, res){
	invoke.issueLc();
});
...
router.route('/install').get(function(req, res){
	install.install();
});

router.route('/instantiate').get(function(req, res){
